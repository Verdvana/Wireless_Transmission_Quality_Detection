...
//接收
	...
	int16 perBuf[100] = {0};                         // Ring buffer for RSSI 存储PER的环形缓冲区  //verdvana 2021.1.4
	uint8 perRssiBufCounter = 0;                     // Counter to keep track of the 计数器用于RSSI缓冲区统计
	uint8 perBufCounter = 0;                         // Counter to keep track of the 计数器用于RSSI缓冲区统计 //verdvana 2021.1.4
