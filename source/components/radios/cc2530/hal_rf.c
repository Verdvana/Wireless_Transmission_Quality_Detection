...
#else
#define CC2530_TXPOWER_MIN_22_DBM   0x05 
#define CC2530_TXPOWER_MIN_20_DBM   0x15 
#define CC2530_TXPOWER_MIN_15_DBM   0x45 
#define CC2530_TXPOWER_MIN_10_DBM   0x65 
#define CC2530_TXPOWER_MIN_5_DBM   0x95 
#define CC2530_TXPOWER_MIN_3_DBM   0xA5 
#define CC2530_TXPOWER_MIN_2_DBM   0xB5 
#define CC2530_TXPOWER_MIN_1_DBM   0xC5 
...
#define HAL_RF_TXPOWER_MIN_22_DBM  0
#define HAL_RF_TXPOWER_MIN_20_DBM  1
#define HAL_RF_TXPOWER_MIN_15_DBM  2
#define HAL_RF_TXPOWER_MIN_10_DBM  3
#define HAL_RF_TXPOWER_MIN_5_DBM  4
#define HAL_RF_TXPOWER_MIN_3_DBM  5
#define HAL_RF_TXPOWER_MIN_2_DBM  6
#define HAL_RF_TXPOWER_MIN_1_DBM  7
#define HAL_RF_TXPOWER_0_DBM      8
#define HAL_RF_TXPOWER_4_DBM	  9
...
static const menuItem_t pPowerSettings[] =
{
  "-22dBm", HAL_RF_TXPOWER_MIN_22_DBM,
  "-20dBm", HAL_RF_TXPOWER_MIN_20_DBM,
  "-15dBm", HAL_RF_TXPOWER_MIN_15_DBM,
  "-10dBm", HAL_RF_TXPOWER_MIN_10_DBM,
  "-5dBm", HAL_RF_TXPOWER_MIN_5_DBM,
  "-3dBm", HAL_RF_TXPOWER_MIN_3_DBM,
  "-2dBm", HAL_RF_TXPOWER_MIN_2_DBM,
  "-1dBm", HAL_RF_TXPOWER_MIN_1_DBM,
  "0dBm", HAL_RF_TXPOWER_0_DBM,
...
#else
    case HAL_RF_TXPOWER_MIN_22_DBM: n = CC2530_TXPOWER_MIN_22_DBM; break;
    case HAL_RF_TXPOWER_MIN_20_DBM: n = CC2530_TXPOWER_MIN_20_DBM; break;
    case HAL_RF_TXPOWER_MIN_15_DBM: n = CC2530_TXPOWER_MIN_15_DBM; break;
    case HAL_RF_TXPOWER_MIN_10_DBM: n = CC2530_TXPOWER_MIN_10_DBM; break;
    case HAL_RF_TXPOWER_MIN_5_DBM: n = CC2530_TXPOWER_MIN_5_DBM; break;
    case HAL_RF_TXPOWER_MIN_3_DBM: n = CC2530_TXPOWER_MIN_3_DBM; break;
    case HAL_RF_TXPOWER_MIN_2_DBM: n = CC2530_TXPOWER_MIN_2_DBM; break;
    case HAL_RF_TXPOWER_MIN_1_DBM: n = CC2530_TXPOWER_MIN_1_DBM; break;
